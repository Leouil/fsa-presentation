...
//#endregion
//#region src/components/AutoStartGate.tsx
...
*/
function AutoStartGate({ visible, onStart }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "auto-gate-card",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "auto-gate-kicker",
					children: "AUTO PLAYBACK"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "auto-gate-title",
					children: "Press SPACE to start"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "auto-gate-sub",
					children: [
						"Audio plays per step and advances automatically.",
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
						"Press ",
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("kbd", { children: "M" }),
						" any time to switch modes."
					]
				})
			]
		})
...
//#endregion
//#region src/components/AutoToggle.tsx
var LABEL = {
	manual: "MANUAL",
	audio: "AUDIO",
	auto: "AUTO"
...
*/
function AutoToggle({ mode, onCycle }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "at-hover",
		"data-no-advance": true,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			title: "切换播放模式（M）",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "at-dot" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "at-label",
				children: LABEL[mode]
			})]
		})
...
var DEFAULT_GITHUB_URL = "https://github.com/ConardLi/garden-skills";
/**
...
*/
function ProgressBar({ chapters, cursor, onJumpChapter, githubUrl = DEFAULT_GITHUB_URL }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [
						...
						isActive && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "pb-pips",
							children: Array.from({ length: c.narrations.length }, (_, s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		...
		}), githubUrl && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
			className: "pb-github",
			href: githubUrl,
			target: "_blank",
...
//#endregion
//#region src/hooks/useStageScale.ts
/**
...
*/
function useStageScale(baseW = 1920, baseH = 1080, marginX = 80, marginY = 100) {
...
*/
function Stage({ onAdvance, children }) {
	const scale = useStageScale();
	const fitterStyle = {
		width: 1920 * scale,
		height: 1080 * scale
	};
	const frameStyle = { transform: `scale(${scale})` };
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "app-shell",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
//#endregion
//#region src/hooks/useAudioPlayer.ts
/**
...
*/
function useAudioPlayer({ src, mode, trailMs = 200, estimateFallbackMs = 1500, onAutoAdvance, autoStarted }) {
	const audioRef = (0, import_react.useRef)(null);
	const onAdvanceRef = (0, import_react.useRef)(onAutoAdvance);
	...
	(0, import_react.useEffect)(() => {
		...
		const advanceAfter = (ms) => {
			...
			if (window.__DISABLE_AUTO_ADVANCE__) return;
		...
		const onVideoEnded = () => advanceAfter(trailMs);
		window.addEventListener("presentation-video-ended", onVideoEnded);
		if (src) {
		...
		} else if (mode === "auto") advanceAfter(estimateFallbackMs);
		return () => {
			advanced = true;
			if (timer != null) clearTimeout(timer);
			window.removeEventListener("presentation-video-ended", onVideoEnded);
...
//#endregion
//#region src/hooks/useAutoMode.ts
var ORDER = [
	"manual",
	"audio",
	"auto"
...
function useAutoMode() {
	const [mode, setModeState] = (0, import_react.useState)(() => readModeFromURL());
	const [autoStarted, setAutoStarted] = (0, import_react.useState)(false);
	...
	const cycleMode = (0, import_react.useCallback)(() => {
	...
	(0, import_react.useEffect)(() => {
		if (mode === "auto") document.body.setAttribute("data-mode", "auto");
...
*/
function sanitize(cursor, chapters) {
	...
	return {
		chapter,
		step: clamp(cursor.step | 0, 0, Math.max(0, stepCount - 1))
	};
}
function useStepper(chapters) {
	...
	const totalGlobal = (0, import_react.useMemo)(() => chapters.reduce((s, c) => s + c.narrations.length, 0), [chapters]);
	const globalIndex = (offsets[cursor.chapter] ?? 0) + cursor.step;
	const next = (0, import_react.useCallback)(() => {
		setCursor((cur) => {
			const c = chapters[cur.chapter];
			if (cur.step < c.narrations.length - 1) return {
				...cur,
				step: cur.step + 1
			};
			if (cur.chapter < chapters.length - 1) return {
				chapter: cur.chapter + 1,
				step: 0
			};
			return cur;
		});
	...
	const prev = (0, import_react.useCallback)(() => {
		setCursor((cur) => {
			...
			if (cur.chapter > 0) {
				...
				return {
					chapter: cur.chapter - 1,
					step: p.narrations.length - 1
				};
			}
			return cur;
		});
	}, [chapters]);
	const jumpToChapter = (0, import_react.useCallback)((idx, step = 0) => {
	...
	const jumpToGlobal = (0, import_react.useCallback)((g) => {
	...
	(0, import_react.useEffect)(() => {
		const onKey = (e) => {
			if (e.target instanceof HTMLInputElement) return;
			const inAutoMode = document.body.getAttribute("data-mode") === "auto";
			if (e.key === " ") {
				e.preventDefault();
				if (!inAutoMode) next();
				...
				e.preventDefault();
				next();
			} else if (inAutoMode) return;
			else if (e.key === "ArrowLeft" || e.key === "Backspace") {
				e.preventDefault();
				prev();
			} else if (e.key === "Home") jumpToChapter(0, 0);
			else if (e.key === "End") {
...
//#endregion
//#region src/chapters/01-hook/narrations.ts
/**
* Chapter 1 — hook: Cold Open · Invisible Name Tags
* 3 steps · ~15s
*/
var narrations$8 = [
	"You open Tesla's latest 10-K, ready to grab some numbers. And every single number on the page is wearing an invisible name tag.",
	"Those name tags are called XBRL. And once you know how to read them, you can pull five years of Tesla's financials without typing a single digit.",
	"One click per number. Five years of data. No typing."
];
narrations$8.length;
//#endregion
//#region src/chapters/01-hook/Hook.tsx
var IMG_DOC = "/assets/01-hook-10k-mockup.png";
function Hook({ step }) {
	if (step === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HookS1, {});
	if (step === 1) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HookS2, {});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HookS3, {});
}
function HookS1() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "hk-stage hk-stage--dark",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "hk-doc-wrap",
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "hk-tag-dot hk-tag-dot--1" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "hk-tag-dot hk-tag-dot--2" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "hk-tag-dot hk-tag-dot--3" })
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "hk-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "hk-narration__text",
				children: narrations$8[0]
			})
		})]
	});
}
...
function HookS3() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "hk-hero__line hk-hero__line--1",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "hk-hero__word",
						children: "One"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "hk-hero__word",
						children: "click"
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "hk-hero__line hk-hero__line--2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "hk-hero__word",
						children: "per"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "hk-hero__word hk-hero__word--accent",
						children: "number."
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hk-hero__rule" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "hk-hero__line hk-hero__line--3",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "hk-hero__word hk-hero__word--muted",
						children: "Five years of data."
					})
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "hk-hero__line hk-hero__line--4",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "hk-hero__word hk-hero__word--muted",
						children: "No typing."
					})
			...
			className: "hk-narration hk-narration--bottom",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "hk-narration__text",
				children: narrations$8[2]
			})
		})]
	});
}
//#endregion
//#region src/chapters/02-what-is-xbrl/narrations.ts
/**
...
narrations$7.length;
//#endregion
//#region src/chapters/02-what-is-xbrl/WhatIsXbrl.tsx
function WhatIsXbrl({ step }) {
	if (step === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(XS1, {});
	if (step === 1) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(XS2, {});
	if (step === 2) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(XS3, {});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(XS4, {});
}
function XS1() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "xs-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			className: "xs-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$7[0] })
		})]
	});
}
function XS2() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "xs-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "xs-xml-diagram",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "xs-xml-tag",
					children: "<Assets>119,437</Assets>"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "xs-xml-arrow",
					children: "↓"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "xs-xml-label",
					children: "Machine-readable"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "xs-xml-sublabel",
					children: "XML · Structured Data"
				})
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "xs-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$7[1] })
		})]
	});
}
function XS3() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			].map(([doc, tag, xbrl], i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "xs-tag-card",
				style: { animationDelay: `${i * .12}s` },
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "xs-tag-card__doc",
						children: doc
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "xs-tag-card__arrow",
						children: "→"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "xs-tag-card__tag",
						children: tag
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "xs-tag-card__xbrl",
						children: xbrl
					})
				]
			}, i))
			...
			className: "xs-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$7[2] })
		})]
	});
}
function XS4() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				{
					icon: "📊",
					label: "Financial\nAnalysts",
					desc: "Valuation models"
				},
				{
					icon: "🏦",
					label: "Investors",
					desc: "Investment decisions"
				},
				{
					icon: "🔍",
					label: "Auditors",
				...
				},
				{
					icon: "⚖️",
					label: "Regulators",
					desc: "SEC · IRS compliance"
				}
			].map((u, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "xs-user-card",
				style: { animationDelay: `${i * .15}s` },
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "xs-user-card__icon",
						children: u.icon
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "xs-user-card__label",
						children: u.label
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "xs-user-card__desc",
						children: u.desc
					})
				]
			}, i))
			...
			className: "xs-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$7[3] })
		})]
	});
}
//#endregion
//#region src/chapters/03-sec-mandate/narrations.ts
/**
* Chapter 3 — sec-mandate: SEC Mandate + Five Statements
* 8 steps · ~33s
*/
var narrations$6 = [
	"And this isn't optional. Since June 2011, the SEC requires every public company to file this way.",
	"Five statements get tagged. One: the balance sheet.",
	"Two: the income statement.",
	"Three: the statement of comprehensive income.",
	"Four: the statement of cash flows.",
	"Five: the statement of stockholders' equity.",
	"And it goes deeper. Even the numbers buried inside the footnotes are tagged — the facts, the figures, the years, the percentages.",
	"Do this once with Tesla — and you can do it with any public company on EDGAR."
];
narrations$6.length;
//#endregion
//#region src/chapters/03-sec-mandate/SecMandate.tsx
function SecMandate({ step }) {
	if (step === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SM1, {});
	if (step === 1) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SM2, {});
	if (step === 2) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SM3, {});
	if (step === 3) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SM4, {});
	if (step === 4) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SM5, {});
	if (step === 5) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SM6, {});
	if (step === 6) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SM7, {});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SM8, {});
}
function SM1() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "sm-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "sm-hero__since",
					children: "Since"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "sm-hero__year",
					children: "June 2011"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "sm-hero__sub",
					children: "XBRL has been mandatory for every public company."
				})
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "sm-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$6[0] })
		})]
	});
}
function SM2() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SMStatement, {
		index: 0,
		text: narrations$6[1]
	});
}
...
function SMStatement({ index, text }) {
	const ALL = [
		"Balance Sheet",
		"Income Statement",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "sm-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "sm-statements",
			children: [
				ALL.slice(0, index).map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "sm-stmt-row sm-stmt-row--done",
					children: s
				}, i)),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "sm-stmt-row sm-stmt-row--active",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "sm-stmt-num",
						children: index + 1
					}), ALL[index]]
				}),
				ALL.slice(index + 1).map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "sm-stmt-row sm-stmt-row--pending",
					children: s
				}, i))
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function SM7() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "sm-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "sm-footnotes",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "sm-footnotes__icon",
					children: "📋"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "sm-footnotes__title",
					children: "Even the footnotes are tagged"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "sm-footnotes__tags",
					children: [
						"Facts",
						"Figures",
						"Years",
			...
			className: "sm-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$6[6] })
		})]
	});
}
function SM8() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "sm-cta",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "sm-cta__rule" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "sm-cta__text",
					children: [
						"Do this once with Tesla —",
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "sm-cta__accent",
							children: "and you can do it with any public company on EDGAR."
						})
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "sm-cta__rule" })
...
//#endregion
//#region src/chapters/04-taxonomy/narrations.ts
/**
...
narrations$5.length;
//#endregion
//#region src/chapters/04-taxonomy/Taxonomy.tsx
function Taxonomy({ step }) {
	if (step === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(T1, {});
	if (step === 1) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(T2, {});
	if (step === 2) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(T3, {});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(T4, {});
}
function T1() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "tx-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
				...
				className: "tx-taxonomy-label",
				children: "US GAAP Financial Reporting Taxonomy"
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "tx-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$5[0] })
		})]
	});
}
function T2() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "tx-tree",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "tx-tree__node tx-tree__node--root",
				children: "Total Assets"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "tx-tree__branch",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "tx-tree__node tx-tree__node--mid",
					children: "Current Assets"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "tx-tree__node tx-tree__node--leaf",
					children: "Cash"
				})]
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "tx-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$5[1] })
		})]
	});
}
function T3() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "tx-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "tx-cash-card",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "tx-cash-card__tag",
					children: "Cash"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "tx-cash-card__def",
					children: "Amount of currency on hand as well as demand deposits with banks or financial institutions. Includes other kinds of accounts that have the general characteristics of demand deposits. Excludes cash and cash equivalent within disposal group and discontinued operation."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "tx-cash-card__footnote",
					children: ["Separate tag for footnote disclosure: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("em", { children: "CashAndCashEquivalentsFootnote" })]
				})
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "tx-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$5[2] })
		})]
	});
}
function T4() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "tx-user__icon",
						children: u.icon
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "tx-user__label",
						children: u.label
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "tx-user__desc",
						children: u.desc
					})
				]
			}, i))
			...
			className: "tx-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$5[3] })
		})]
	});
}
//#endregion
//#region src/chapters/05-hands-on-setup/narrations.ts
/**
...
narrations$4.length;
//#endregion
//#region src/chapters/05-hands-on-setup/HandsOnSetup.tsx
function HandsOnSetup({ step }) {
	if (step === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HS1, {});
	if (step === 1) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HS2, {});
	if (step === 2) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HS3, {});
	if (step === 3) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HS4, {});
	if (step === 4) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HS5, {});
	if (step === 5) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HS6, {});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HS7, {});
}
function HS1() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "hs-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			className: "hs-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$4[0] })
		})]
	});
}
function HS2() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "hs-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "hs-highlight-card",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "hs-highlight-card__label",
					children: "Navigate to"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "hs-highlight-card__part",
					children: "Part II, Item 8"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "hs-highlight-card__desc",
					children: "Financial Statements & Supplementary Data"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "hs-highlight-card__sub",
					children: "Balance Sheet + Statements of Operations"
				})
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "hs-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$4[1] })
		})]
	});
}
function HS3() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "hs-tag-callout",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "hs-tag-callout__tag",
					children: "us-gaap:AssetsCurrent"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "hs-tag-callout__label",
					children: "← the tag name"
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "hs-narration",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$4[2] })
			})
		]
	});
}
function HS4() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			className: "hs-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$4[3] })
		})]
	});
}
function HS5() {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "hs-step-arrow",
						children: "→"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "hs-step-btn hs-step-btn--highlight",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "hs-hint",
				children: "Now it's yours to edit."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "hs-narration",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$4[4] })
			})
		]
	});
}
function HS6() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "hs-ticker-swap",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "hs-ticker hs-ticker--old",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "hs-ticker__label",
							children: "Current"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "hs-ticker__value",
							children: "MSFT"
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "hs-ticker-arrow",
						children: "→"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "hs-ticker hs-ticker--new",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "hs-ticker__label",
							children: "Tesla"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "hs-ticker__value hs-ticker__value--accent",
							children: "TSLA"
						})]
					})
				]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "hs-year-row",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "hs-year-label",
						children: "Year:"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "hs-year-value",
						children: "2025"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "hs-year-sub",
						children: "← auto-pulls 2021–2025"
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "hs-narration",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$4[5] })
			})
		]
	});
}
function HS7() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "hs-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "hs-data-ready",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "hs-data-ready__icon",
				children: "✓"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "hs-data-ready__text",
				children: [
					"Five years of Tesla data",
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "hs-data-ready__years",
			...
			className: "hs-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$4[6] })
		})]
	});
}
//#endregion
//#region src/chapters/06-balance-sheet-numbers/narrations.ts
/**
...
narrations$3.length;
//#endregion
//#region src/chapters/06-balance-sheet-numbers/BalanceSheet.tsx
var ROWS = [
	"Total current assets",
	"Total assets",
	"Total current liabilities",
...
function BalanceSheet({ step, mode }) {
	if (step === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BS1, {});
	if (step >= 1 && step <= 6) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BSRows, { step });
	if (step === 7) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BSAssetsCurrent, {});
	if (step === 8) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BSCopyTags, {});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BSVideo, { mode });
}
function BS1() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "bs-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "bs-target",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "bs-target__label",
				children: "Target:"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "bs-target__count",
				children: "6 Balance Sheet Numbers"
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "bs-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$3[0] })
		})]
	});
}
function BSRows({ step }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "bs-highlight-overlay",
				children: ROWS.slice(0, visibleCount).map((r, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "bs-highlight-row",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "bs-narration",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$3[step] })
			})
		]
	});
}
function BSAssetsCurrent() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "bs-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "bs-assetscurrent",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "bs-assetscurrent__row",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "bs-assetscurrent__label",
					children: "Total current assets"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "bs-assetscurrent__tag",
					children: "AssetsCurrent"
				})]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "bs-assetscurrent__data",
				children: [
					"2021",
					"2022",
					"2023",
					"2024",
					"2025"
				].map((yr, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "bs-assetscurrent__cell",
					style: { animationDelay: `${i * .1}s` },
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "bs-assetscurrent__yr",
						children: yr
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "bs-assetscurrent__num",
						children: "47,291"
					})]
				}, i))
			})]
			...
			className: "bs-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$3[7] })
		})]
	});
}
function BSCopyTags() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "bs-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "bs-copy-tags",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "bs-copy-tags__step",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "bs-copy-tags__num",
						children: "1"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "bs-copy-tags__text",
						children: "Go back to the 10-K"
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "bs-copy-tags__step",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						className: "bs-copy-tags__text",
						children: "Click each line — copy the XBRL tag"
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "bs-copy-tags__step",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						className: "bs-copy-tags__text",
						children: "Paste it in the Google Sheet"
					})]
				})
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "bs-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$3[8] })
		})]
	});
}
function BSVideo({ mode }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "bs-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "bs-video-wrap",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "bs-video-label",
					children: "Demo: Add a new row & type the XBRL tag"
				}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "bs-video-hint",
					children: ["Copy an existing row → paste to new line → replace ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { children: "[Add XBRL Tag Here]" })]
				})
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "bs-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$3[9] })
		})]
	});
}
//#endregion
//#region src/chapters/07-income-statement/narrations.ts
/**
* Chapter 7 — income-statement: Three Income Statement Numbers
* 5 steps · ~20s
*/
var narrations$2 = [
	"Then the income statement. Three numbers this time.",
	"Total revenues.",
	"Total cost of revenues.",
	"And gross profit.",
	"Same game — find the tags, drop them in, and watch 2021 to 2025 fill up."
];
narrations$2.length;
//#endregion
//#region src/chapters/07-income-statement/IncomeStatement.tsx
function IncomeStatement({ step }) {
	if (step === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(IS1, {});
	if (step === 1) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ISRow, {
		label: "Total revenues",
		tag: "Revenues",
		step
	});
	if (step === 2) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ISRow, {
		label: "Total cost of revenues",
		tag: "CostOfRevenue",
		step
	});
	if (step === 3) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ISRow, {
		label: "Gross profit",
		tag: "GrossProfit",
		step
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ISDone, {});
}
function IS1() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "is-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "is-target",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "is-target__label",
				children: "Income Statement"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "is-target__count",
				children: "Three Numbers"
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "is-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$2[0] })
		})]
	});
}
function ISRow({ label, tag, step }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "is-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "is-row",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "is-row__label",
				children: label
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "is-row__tag",
				children: tag
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "is-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$2[step] })
		})]
	});
}
function ISDone() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "is-done",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "is-done__years",
				children: "2021 · 2022 · 2023 · 2024 · 2025"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "is-done__check",
				children: "✓ All three income statement numbers filled"
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "is-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$2[4] })
		})]
	});
}
//#endregion
//#region src/chapters/08-verify/narrations.ts
/**
...
narrations$1.length;
//#endregion
//#region src/chapters/08-verify/Verify.tsx
function Verify({ step }) {
	if (step === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(VQ1, {});
	if (step === 1) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(VQ2, {});
	if (step === 2) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(VQSpoiler, {});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(VQHint, {});
}
function VQ1() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "vq-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "vq-equation vq-equation--pending",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "vq-equation__label",
				children: "Equation 1"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "vq-equation__formula",
				children: [
			...
			className: "vq-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$1[0] })
		})]
	});
}
function VQ2() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "vq-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "vq-equation vq-equation--check",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "vq-equation__label",
					children: "Equation 2 ✓"
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "vq-equation__formula",
					children: "Gross Profit = Total Revenues − Total Cost of Revenues"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "vq-equation__status",
					children: "Holds"
				})
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "vq-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$1[1] })
		})]
	});
}
function VQSpoiler() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "vq-equation vq-equation--fail",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "vq-equation__label",
						children: "Equation 1 ✗"
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "vq-equation__formula",
						children: "Total Liabilities & Equity ≠ Liabilities + Stockholders' Equity"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "vq-equation__status",
						children: "Fails — something sits in between"
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "vq-mezzanine",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "vq-mezzanine__label",
					children: "? Something between"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "vq-mezzanine__blocks",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "vq-mezzanine__block vq-mezzanine__block--liab",
							children: "Liabilities"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "vq-mezzanine__block vq-mezzanine__block--mid",
							children: [
								"Redeemable",
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
								"NCI"
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "vq-mezzanine__block vq-mezzanine__block--equity",
							children: [
								"Stockholders'",
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
								"Equity"
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "vq-narration",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$1[2] })
			})
		]
	});
}
function VQHint() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "vq-hint",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "vq-hint__icon",
				children: "🔍"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "vq-hint__text",
				children: [
					"Find it in Tesla's balance sheet.",
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
			...
			className: "vq-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations$1[3] })
		})]
	});
}
//#endregion
//#region src/chapters/09-beyond-numbers/narrations.ts
/**
* Chapter 9 — beyond-numbers: Beyond Financials: MD&A + Auditor Report
* 5 steps · ~36s
*/
var narrations = [
	"Last stop. A 10-K is way more than financial statements. It has four parts in total.",
	"Two sections matter most for analysts. Item 7 — the MD&A, management's own discussion of the business. And Item 8 — the financial statements.",
	"In Item 7, your job: count how many subsections it has, and find the four opportunities management lists in the 2026 outlook.",
	"In Item 8, find the report of the independent auditor. Who signs Tesla's books? Since when? And is the opinion unqualified?",
	"Tags, sheet, verification, story. Do this once with Tesla — and you can do it with any public company on EDGAR."
];
narrations.length;
//#endregion
//#region src/chapters/09-beyond-numbers/BeyondNumbers.tsx
function BeyondNumbers({ step }) {
	if (step === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BN1, {});
	if (step === 1) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BN2, {});
	if (step === 2) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BN3, {});
	if (step === 3) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BN4, {});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BN5, {});
}
function BN1() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "bn-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			className: "bn-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations[0] })
		})]
	});
}
function BN2() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "bn-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "bn-two-items",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "bn-item-card bn-item-card--highlight",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "bn-item-card__num",
						children: "Item 7"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "bn-item-card__name",
						children: "MD&A"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "bn-item-card__sub",
						children: "Management Discussion & Analysis"
					})
				]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "bn-item-card bn-item-card--highlight",
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "bn-item-card__sub",
						children: "& Supplementary Data"
					})
				]
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "bn-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations[1] })
		})]
	});
}
function BN3() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "bn-stage",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "bn-questions",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "bn-questions__title",
				children: "Q2 — Item 7 MD&A"
			}), ["How many subsections does Item 7 have, and what are they?", "In the 2026 Outlook subsection — what are the four opportunities or changes identified by management?"].map((q, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "bn-question",
				style: { animationDelay: `${i * .15}s` },
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "bn-question__num",
					children: [
						"Q",
						i + 1,
						"."
					...
					className: "bn-question__text",
					children: q
				})]
			}, i))]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "bn-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations[2] })
		})]
	});
}
function BN4() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "bn-questions__title",
				children: "Q3 — Item 8 Auditor Report"
			}), ["Which CPA firm is the current auditor, and when did it become Tesla's auditor?", "Is the opinion unqualified based on the auditor's report? Explain the reasons for your answer."].map((q, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "bn-question",
				style: { animationDelay: `${i * .15}s` },
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "bn-question__num",
			...
			className: "bn-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations[3] })
		})]
	});
}
function BN5() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "bn-outro",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "bn-outro__rule" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "bn-outro__text",
					children: "Tags, sheet, verification, story."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "bn-outro__sub",
					children: [
						"Do this once with Tesla —",
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
			...
			className: "bn-narration",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: narrations[4] })
		})]
	});
}
//#endregion
//#region src/registry/chapters.ts
/**
...
var CHAPTERS = [
	{
		id: "hook",
		title: "Cold Open: Invisible Name Tags",
		narrations: narrations$8,
		Component: Hook
	},
	{
		id: "what-is-xbrl",
		title: "What XBRL Actually Is",
		narrations: narrations$7,
		Component: WhatIsXbrl
	},
	{
		id: "sec-mandate",
		title: "SEC Mandate + Five Statements",
		narrations: narrations$6,
		Component: SecMandate
	},
	{
		id: "taxonomy",
		title: "US GAAP Taxonomy",
		narrations: narrations$5,
		Component: Taxonomy
	},
	{
		id: "hands-on-setup",
		title: "Hands-On: Tesla 10-K + Sheet",
		narrations: narrations$4,
		Component: HandsOnSetup
	},
	{
		id: "balance-sheet-numbers",
		title: "Six Balance Sheet Numbers",
		narrations: narrations$3,
		Component: BalanceSheet
	},
	{
		id: "income-statement",
		title: "Three Income Statement Numbers",
		narrations: narrations$2,
		Component: IncomeStatement
	},
	{
		id: "verify",
		title: "Q1: Verify the Two Equations",
...
function App() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Stage, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "scene",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Cmp, {
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AutoToggle, {
			mode,
			onCycle: cycleMode
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AutoStartGate, {
